...
<a name="shouts">*Huge shout-outs</a> to the rock-steady modders: JimK72, TheOrangeFloof, Critical_Fail, Donovan, Waldo, Semac, R3ap3r, Sara, laanp, Nic, & venomtron -- thank you all for the tips, inspiration, and ongoing work to improve Icarus!*
...
*__CAUTION__*: This mod may conflict with other mods! Recommended to use alone, or with mods known not to change these json files: "D_WorkshopItems", "D_Equippable", and "D_Itemable". Or, use Mod Manager to choose your desired changes. [Mod Manager](https://github.com/Jimk72/Icarus_Software) highly recommended!

-- [*__Return to mod list__*](#modlist)

---

18. <a name="18">__Enhanced Tactical Backpack__</a> (Direct link: https://bit.ly/CKDbackpack)
...
*__CAUTION__*: This mod may conflict with other mods! Recommended to use alone, or with mods known not to change these json files: "D_WorkshopItems", "D_Equippable". Or, use Mod Manager to choose your desired changes. [Mod Manager](https://github.com/Jimk72/Icarus_Software) highly recommended!
...
20. <a name="20">__Cook All the Things!__</a> (Direct link: https://bit.ly/CKDstoves)
...
*__CAUTION__*: This mod may conflict with other mods! Recommended to use alone, or with mods known not to change "D_ItemStatic", "D_WorkshopItems", and "D_Itemable"; or use Mod Manager to choose your desired changes. [Mod Manager](https://github.com/Jimk72/Icarus_Software) highly recommended!
...
24. <a name="24">__StormFront__</a> (Direct link: https://bit.ly/CKDstormfront)
...
*__CAUTION__*: This mod may conflict with other mods! Recommended to use alone, or with mods known not to change "D_ProspectForecast"; or use Mod Manager to choose your desired changes. [Mod Manager](https://github.com/Jimk72/Icarus_Software) highly recommended!
