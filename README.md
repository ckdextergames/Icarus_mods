...
__EPS: Enzyme Power Smoothies__
...
*__CAUTION__:* This mod may conflict with other mods! Recommended to use alone, or with mods known not to change "D_ModifierStates.json", "D_ProcessorRecipes", "D_ItemStatic", "D_ItemTemplate", "D_Consumable", "D_Meshable", and "D_Itemable", or use Mod Manager to choose your desired changes.
