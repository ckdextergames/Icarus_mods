...
- Much higher exotics rewarded
- Four enzymes rewarded, not just one (for use in your Enzyme Power Smoothies!)
...
* This mod may conflict with other mods! Recommended to use alone, or with mods known not to change "D_ItemsRewards.json" & "D_Horde"; or use Mod Manager to choose your desired changes.
