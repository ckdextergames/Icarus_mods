...
*Compatible with Icarus Week 108 update, or the current later game build if updated with Icarus Mod Manager.*
...
* This mod may conflict with other mods! Recommended to use alone, or with mods known not to change "D_ItemTemplate" and "D_Itemable"; or use Mod Manager to choose your desired changes.
