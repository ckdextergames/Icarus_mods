...
__The "Panther" Enhanced Suit Module__
...
*__CAUTION__*: This mod may conflict with other mods! Recommended to use alone, or with mods known not to change these json files: "D_WorkshopItems", "D_Equippable", and "D_Itemable". Or, use Mod Manager to choose your desired changes.
