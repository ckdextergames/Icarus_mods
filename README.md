...
- All four of the Prometheus "Exploration" missions will have 4 times the number of exotic spawn points as in vanilla (this includes both purple and red, there's no way to separate them, so there's just a higher chance of more reds to occur along with purples).
- Any red exotic sites that spawn will yield 4 times the number of exotics as in vanilla.
---

<a name="shouts">*Huge shout-outs</a> to the rock-steady modders: JimK72, TheOrangeFloof, Critical_Fail, Donovan, Waldo, Semac, R3ap3r, Nic, laanp, & venomtron -- thank you all for the tips, inspiration, and ongoing work to improve Icarus!*
