...
<a name="mod">__Tactical Icebox Backpack__</a>
...
<a name="shouts">*Huge shout-outs</a> to the rock-steady modders: JimK72, TheOrangeFloof, Critical_Fail, Donovan, Waldo, Semac, R3ap3r, Nic, & venomtron -- thank you all for the tips, inspiration, and ongoing work to improve Icarus!* Special thanks for this mod goes to Prophet, Sen deNoir, and Nilt for their inspiration and guidance.
...
*__CAUTION__*: This mod may conflict with other mods! Recommended to use Icarus Mod Manager to choose your desired changes.
