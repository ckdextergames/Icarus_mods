...
<a name="mod">__Animal Madness__</a>
...
*__CAUTION__*: This mod may conflict with other mods! Recommended to use alone, or with mods known not to change these json files: "D_AISpawnRules", "D_AISpawnZones", "D_AIAutonomousSpawns", "D_ProspectStats", and "D_EpicCreatures". Or, use Mod Manager to choose your desired changes.
